...
graph TB
    ...
    Waiter((fa:fa-users Waiters)) -. "Uses PDQ device to take<br/>payments at the<br/>table" .-> OAT(<strong style="font-weight: 600">Order at Table</strong><br/><br/>Provide users ability to<br/>join a table, order food and <br/>pay for food at<br/>one of Zizzi<br/>or ASK Italian restaurants )
    end
